package com.gustibimo.simplechat.security;
...
public class TokenHelper {
	...
	private Date generateExpirationDate() {
		...
		return new Date(getCurrentTimeMillis() + JwtConstant.EXPIRES_IN * 1000);
	}
	...
	public String getToken(HttpServletRequest request) {
		 ...
		 */
		Cookie authCookie = getCookieValueByName(request, JwtConstant.AUTH_COOKIE);
		if (authCookie != null) {
