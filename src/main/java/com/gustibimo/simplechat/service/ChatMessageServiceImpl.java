...
import com.gustibimo.simplechat.repository.ChatMessageRepository;

@Service
public class ChatMessageServiceImpl implements com.gustibimo.simplechat.service.ChatMessageService {
	@Autowired
